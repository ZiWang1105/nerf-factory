...
class LitFogNeRF(LitModel):
    def __init__(
        ...
        # self.airlight = torch.tensor([[247.35407622, 248.69223348, 250.51664255]]).cuda() / 255.0 # output_foggy_world_with_depth_1822-1999
        # self.airlight = torch.tensor([[225.63241679, 232.39073806, 239.92185239]]).cuda() / 255.0 # output_clear_world_with_depth_160-240_physics_fog
    ...
    def configure_optimizers(self):
        ...
        #         {'params': self.beta, 'lr': self.lr_init}, 
        #         {'params': self.airlight, 'lr': self.lr_init}
        #     ], 
        #     lr=self.lr_init,
        #     betas=(0.9, 0.999)
        # )
